...
namespace Projekt_Biluthyrning {
	internal class Booking {
		...
		public Booking(string inputBookingName, int inputAge, string inputAddress, string inputMail, string inputPhoneNumber, string inputStartDate, string inputEndDate ) {
